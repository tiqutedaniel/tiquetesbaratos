...
const loadEventListeners = () => {
    ...
    btnSelectFlight.forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            info.flightInfo.seat_type_back = e.currentTarget.dataset.flightLevel;
            info.flightInfo.aeroline_back = e.currentTarget.dataset.aeroline;
            updateLS();
...
const sendStatus = () =>{
    const tokenn = KJUR.jws.JWS.sign(null, { alg: "HS256" }, {message: 'P3'}, JWT_SIGN);
